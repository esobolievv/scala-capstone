...
object Interaction2 extends Interaction2Interface {
  ...
  val COLOR_SCALE: Array[(Temperature, Color)] = Array((7.0, Color(0, 0, 0)), (4.0, Color(255, 0, 0)), (2.0, Color(255, 255, 0)),
  ...
  def availableLayers: Seq[Layer] = {
    Array(Layer(LayerName.Temperatures, COLOR_SCALE, 1990 to 2015),
      Layer(LayerName.Deviations, COLOR_SCALE, 1990 to 2015))
  }
